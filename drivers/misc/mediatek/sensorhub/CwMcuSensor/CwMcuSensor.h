...
extern int CWMCU_bus_write_serial(struct CWMCU_T *sensor,u8 *data, int len);
extern int CWMCU_bus_read_serial(struct CWMCU_T *sensor,u8 *data, int len);
extern int CWMCU_bus_read(struct CWMCU_T *sensor, u8 reg_addr, u8 *data, u8 len);
extern int CWMCU_bus_write(struct CWMCU_T *sensor, u8 reg_addr, u8 *data, u8 len);
...
extern void factory_clear_calibrator_data(struct CWMCU_T *sensor,int sensor_id);
